...
class ContactRVAdapter extends RecyclerView.Adapter<ContactRVAdapter.ViewHolder> {
    ...
    // variables for context and array list.
    ...
    // method for filtering data in our array list
    public void filterList(ArrayList<ContactsModal> filterllist) {
        // passing filtered array list in our original array list
    ...
    public void onBindViewHolder(@NonNull ContactRVAdapter.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("contact", modal.getTelephone());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        // variable for our image view and text view.
