...
public class MainActivity extends AppCompatActivity {
    ...
    // variables for array list, recycler view progress bar and adapter
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // call method to prepare recycler view.
        prepareContactRV();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        // call menu inflater and inflating menu file
        MenuInflater inflater = getMenuInflater();
        inflater.inflate(R.menu.search_menu, menu);
        // get menu item as search view item
        MenuItem searchViewItem = menu.findItem(R.id.app_bar_search);
        // variable for search view
        final SearchView searchView = (SearchView) MenuItemCompat.getActionView(searchViewItem);
        // set on query text listener for search view
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            @Override
            public boolean onQueryTextSubmit(String query) {
                // on query submit clear the focus for search view.
            ...
            public boolean onQueryTextChange(String newText) {
                // on changing the text in search view, call filter method to filter array list
    ...
    private void filter(String text) {
        // method filter array list creating a new filtered array list
        ArrayList<ContactsModal> filteredlist = new ArrayList<>();
        // run loop for checking if the item is present in array list
        for (ContactsModal item : contactsModalArrayList) {
            if (item.getName().toLowerCase().contains(text.toLowerCase())) {
                // add item to filtered array list
        ...
        if (filteredlist.isEmpty()) {
            ...
            // pass this filtered list to adapter with filter list method
            contactRVAdapter.filterList(filteredlist);
        }
    }

    private void prepareContactRV() {
        // method preparing recycler view with adapter
    ...
    private void requestPermissions() {
        ...
        Dexter.withActivity(this)
                // request number of permissions which are required in app
